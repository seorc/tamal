...
class Bootstrap extends Context {
    ...
    public function runMiddlewareValidation(): void {
        for ($i = 0; $i < \count($this->middleware); ++$i) {
    ...
    protected function deployException(\Exception $e): void {
        $e_class = \get_class($e);
        $not_error_e = [
    ...
    protected function runMiddlewareReq(\tamal\web\Request $req): void {
    ...
    protected function runMiddlewareRes(\tamal\web\Response $res): void {
