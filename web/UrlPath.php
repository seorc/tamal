...
class UrlPath {
	...
	const DEFAULT_REGEXP = "/([a-zA-Z0-9_-].*\/)+/";

	const NONE = "";
	const CHOP_PATH = "chop";
	const SLASH = "/";
	 ...
	 */
	public function setPathMatcher($regexp = self::DEFAULT_REGEXP) {
		$this->regexp = $regexp;
	}
	 ...
	 */
	protected function loadMatches(array $matches) {
